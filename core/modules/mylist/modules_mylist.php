...
/**
 *  \file		htdocs/mylistmore/core/modules/mylist/modules_mylist.php
 *  \ingroup	mylist
...
abstract class ModeleNumRefFactory
{
	...
	{
		global $langs;
		$langs->load("mylistmore@mylistmylistmore");
	...
	{
		global $langs;
		$langs->load("mylistmylistmore@mylistmylistmore");
...
function mylist_create($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
	...
	$langs->load("mylistmore@mylistmore");
